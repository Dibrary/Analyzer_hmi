...
public:
	...
	jfloat CallStaticFloatMethod(JNIEnv* pJNIEnv, jclass cl, jmethodID methodID, ...);
	...
	jshortArray NewShortArray(JNIEnv* pJNIEnv, jsize len);
	...
	void SetShortArrayRegion(JNIEnv* pJNIEnv, jshortArray array, jsize start, jsize len, jshort *buf);
