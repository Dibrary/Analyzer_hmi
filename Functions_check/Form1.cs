...
namespace Functions_check
{
    public partial class Form1 : Form
    {
        ...
        Functions_check.Logger logger = new Functions_check.Logger();
        ...
        private double[] computeAbsoluteIrradiance(double[] wl, double[] spectrum, double[] cal, double collectionArea, int integrationTimeMillisec)
        {
        ...
        private void updateGraph()
        {
            ...
            try
            {
                foreach (int specIndex in specIndices)
                {
                    ...
                    if (series == null || wavelengths[specIndex] == null || graphableSpectrum[specIndex] == null || graphableSpectrum[specIndex].Length != pixels[specIndex])
                    {
                    ...
                    for (int i = 0; i < pixels[specIndex]; i++)
                    {
                        ...
                        //logger.display(wavelengths[specIndex][i].ToString());
                    }
                }
            }
            catch (Exception e)
